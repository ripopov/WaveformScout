...
from ..rendering.canvas_layout import CanvasLayout, build_layout, VisibleRow
...
from ..rendering.signal_renderer import (
...
from ..rendering.signal_sampling import (
    SignalDrawingData,
...
from ..core.data_model import SignalRangeCache
from ..rendering.time_grid_renderer import TimeGridRenderer, TickInfo
                        ...
                        if group_id not in signal_range_cache or signal_range_cache[group_id].min == float('inf'):
                            ...
                            for child in row.descriptor.children:
                                ...
                                if signal_obj is not None:
                                    from ..rendering.signal_renderer import compute_global_signal_range
                            ...
                            from ..core.data_model import DataFormat
